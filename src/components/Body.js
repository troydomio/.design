...
export const Body = () => {
    return (
        <div className='body'>
            <div>
                <a href="https://www.behance.net/gallery/135409745/Spoiled-Stop-Food-Waste-Case-Study" target="_blank"><img src="https://live.staticflickr.com/65535/51830150915_09141d600e_b.jpg" alt="an image of a cell phone displaying a fictional app called 'spoiled' which is a project to eliminate food waste."></img></a>
            </div>
            <div>
                ...
                <a href="mailto:troy_domio@yahoo.com"><p>troy_domio@yahoo.com</p></a>
            </div>
        </div>
    )
}
